...
def inner_func_test(n, dataset, dim, folder_name):
    ...
    mu_val_list = [1.5, 10.0, 20, 30, 40, 50, 70, 90, 100]
    ...
    estimator = myskorch.FeedForwardClassifier(batch_size = 256, max_epochs = 100, module__hidden_layers = [64], module__use_batch_norm = False, module__dropout = 0, optimizer__lr = 0.0001, optimizer__weight_decay = 0, optimizer__amsgrad = False, device='cpu')
