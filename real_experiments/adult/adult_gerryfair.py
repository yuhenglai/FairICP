...
def inner_func_test(n, dataset, dim, folder_name):
    ...
    batch_size_list = [256]
    lr_loss_list = [0.005]
    mu_val_list = [0.003, 0.0035, 0.004, 0.0045, 0.005, 0.0055, 0.006, 0.0065, 0.007, 0.0075, 0.008, 0.009, 0.01, 0.012, 0.015]
    ...
    for batch_size in batch_size_list:
        for lr_loss in lr_loss_list:
            for mu_val in mu_val_list:
                estimator = SimpleNN(input_dim = X_train.shape[1], hidden_dim = 64, epochs = 5, batch_size = batch_size, learning_rate = lr_loss)
